...
import { Plane, Truck, Train, Zap, FileText, Warehouse, Check, ArrowRight, Phone } from "lucide-react"
...
export const metadata: Metadata = {
  title: "Our Services",
  description: "Comprehensive logistics services - Air Cargo, Surface Transport, Rail Cargo, Express Delivery, Document Delivery, and Warehousing across 21,000+ pin codes.",
}
      ...
      <section className="relative py-20 lg:py-28 bg-gradient-to-br from-primary-950 via-primary-900 to-primary-800">
        <div className="container mx-auto px-4 relative z-10">
          <AnimatedSection className="text-center max-w-3xl mx-auto">
            <Badge variant="secondary" className="mb-4">Comprehensive Solutions</Badge>
            <h1 className="text-4xl lg:text-6xl font-bold text-white mb-6">
              Our Services
            </h1>
            <p className="text-lg text-white/70 leading-relaxed">
              End-to-end logistics solutions designed to meet every business need — 
              from express deliveries to bulk cargo transportation across India.
            </p>
          </AnimatedSection>
        </div>
      </section>
            ...
            {services.map((service) => {
              ...
              return (
                <StaggerItem key={service.id}>
                  <Card id={service.id} className="h-full hover:glow transition-all duration-300">
                    <CardHeader>
        ...
        <div className="container mx-auto px-4">
          <AnimatedSection className="text-center mb-12">
            ...
            <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
              Explore each service in detail to find the perfect solution for your needs
            </p>
          </AnimatedSection>
          ...
          <AnimatedSection>
            <Tabs defaultValue="air-cargo" className="max-w-4xl mx-auto">
              <TabsList className="grid grid-cols-3 lg:grid-cols-6 h-auto gap-2 mb-8">
                {services.map((service) => (
                  <TabsTrigger key={service.id} value={service.id} className="text-xs lg:text-sm py-3">
                          ...
                          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center p-4 bg-primary/5 rounded-lg">
                            {service.price_starting && (
                              <div>
                                ...
                                <p className="text-xl font-bold text-primary">{service.price_starting}</p>
                              </div>
                            )}
          ...
          <AnimatedSection>
            <Card className="p-8 lg:p-12 text-center bg-gradient-to-r from-primary-900 to-primary-800 text-white border-0">
              ...
              <p className="text-white/70 max-w-2xl mx-auto mb-8">
                Our team will work with you to design a tailored logistics plan that fits 
                your business requirements and budget.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/contact">
                  <Button size="lg" className="bg-secondary hover:bg-secondary-600 text-white gap-2">
                    Contact Us
